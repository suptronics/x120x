...
try:
    ...
    while True:
        ...
        for _ in range(SHUTDOWN_THRESHOLD):
            ...
            #3.87-4.2 discharging levels of 100%
            #3.7-3.87 discharging levels of 75%
            #3.55-3.7 discharging levels of 50%
            #3.4-3.55 discharging levels of 25%
            #<3.4     low battery
        ...
        if failure_counter >= SHUTDOWN_THRESHOLD:
            ...
            #custom_log('einfo', "System operating within normal parameters. No action required.","False")
